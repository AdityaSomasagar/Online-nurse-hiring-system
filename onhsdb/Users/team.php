...
if (isset($_GET['page_no']) && $_GET['page_no'] != "") {
    $page_no = (int)$_GET['page_no']; // Sanitize input
} else {
    $page_no = 1;
}
                ...
                while ($result = mysqli_fetch_array($query)) {
                    ...
                    <div class="row mt-5 pb-lg-5">
                        <div class="col-md-4 border p-0 my-auto">
                            <img src="admin/images/<?php echo htmlspecialchars($result['ProfilePic']); ?>" class="img-fluid" alt="team-img" />
                        </div>
                        <div class="col-md-8 team-text mt-md-0 mt-5">
                            ...
                            <ul class="list-group mb-3">
                                <li class="list-group-item border-0">
                                    <i class="far fa-check-square mr-3"></i><?php echo htmlspecialchars($result['Address']); ?></li>
                                <li class="list-group-item border-0 py-0">
                                    <i class="far fa-check-square mr-3"></i>
                                    Experience : <?php echo htmlspecialchars($result['NursingExp']); ?> years</li>
                                <li class="list-group-item border-0">
                                    <i class="far fa-check-square mr-3"></i>
                                    State : <?php echo htmlspecialchars($result['State']); ?></li>
                                <li class="list-group-item border-0 py-0">
                                    <i class="far fa-check-square mr-3"></i>City : <?php echo htmlspecialchars($result['City']); ?></li>
                                <li class="list-group-item border-0">
                                    <i class="far fa-check-square mr-3"></i>
                                    Language Known: <?php echo htmlspecialchars($result['LanguagesKnown']); ?>
                                </li>
                                <li class="list-group-item border-0">
                                    <i class="far fa-check-square mr-3"></i>
                                    Certificate: <?php echo htmlspecialchars($result['NursingCertificate']); ?>
                                </li>
                            </ul>
                            <a href="book-nurse.php?bookid=<?php echo htmlspecialchars($result['ID']); ?>" class="btn_apt">make an appointment</a>
                        </div>
                    </div>
                    <?php
                }
